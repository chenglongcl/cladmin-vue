...
gulp.task('replace:cdnUrl', function () {
  return gulp.src(`${versionPath}/static/js/runtime.js`)
...
gulp.task('default', gulp.series('clean', 'getEnv', 'build', 'create:versionCatalog', 'replace:cdnUrl', 'replace:version', 'concat:config', function () {
  // 清除, 编译 / 处理项目中产生的文件
